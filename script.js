  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (fieldType !== 'checkbox' && fieldType !== 'radio') {
        ...
        if (fieldType === 'email' || rules.includes('email')) {
        ...
        if (fieldType === 'tel' || rules.includes('phone')) {
        ...
        const minLengthRule = rules.find(function (r) { return r.startsWith('minLength:'); });
        if (minLengthRule) {
          const length = minLengthRule.split(':')[1];
          if (!validators.minLength(value, length)) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Adon Novo משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2f4f0b2c-df56-4aff-a90a-034099b8b1fa',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2f4f0b2c-df56-4aff-a90a-034099b8b1fa';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2f4f0b2c-df56-4aff-a90a-034099b8b1fa';
